...
add foreign key(Batch_Id) references BatchDetails(Batch_Id);

alter table Student_Status
add column Faculty_Id varchar(20),
...
insert into FacultyDetails values ('F006','Mr.','MANOJ AGRAWAL' ,'Mumbai','Mainframe','Bachelor of Technology',9,'Manoj.Agrawal@alliance.com','ac6@123');
...
insert into BatchDetails values('B001','MRS.SWATI ROY','MSP');
insert into BatchDetails values('B002','MRS.ARURNA K','HEALTHCARE');
insert into BatchDetails values('B003','MR.RAJESH KRISHNAN','LIFE SCIENCES');
insert into BatchDetails values('B004','MR.SACHIN SHETTY','BFS');
insert into BatchDetails values('B005','MR.RAMESH PATEL','COMMUNICATIONS');
insert into BatchDetails values('B006','MRS.SUSAN CHERIAN','RETAIL & HOSPITALITY');
insert into BatchDetails values('B007','MRS.SAMPADA JAIN','MSP');
insert into BatchDetails values('B008','MRS.KAVITA REGE','BPO');
insert into BatchDetails values('B009','MR.RAVI SEJPAL','MSP');
...
insert into ModuleDetails values('EM001','Instructor',0);
insert into ModuleDetails values('EM002','Course Material',0);
insert into ModuleDetails values('EM003','Learning Effectiveness',0);
insert into ModuleDetails values('EM004','Environment',0);
insert into ModuleDetails values('EM005','Job Impact',0);
insert into ModuleDetails values('TM001','Attendees',0);
insert into ModuleDetails values('TM002','Course Material',0);
insert into ModuleDetails values('TM003','Environment',0);
